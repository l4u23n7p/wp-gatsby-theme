...
function project_updated_messages( $messages ) {
	...
	$messages['project'] = array(
		...
		9  => sprintf(
			__( 'Project scheduled for: <strong>%1$s</strong>. <a target="_blank" href="%2$s">Preview Project</a>', 'wp-gatsby-theme' ),
			date_i18n( __( 'M j, Y @ G:i', 'wp-gatsby-theme' ), strtotime( $post->post_date ) ),
			esc_url( $permalink )
		),
		/* translators: %s: post permalink */
